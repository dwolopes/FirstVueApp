var vm = new Vue({
  ...
  watch: {
    distance: function (newDistance) {
      if(newDistance <= 0) return this.msg = 'A distância deve ser maior que Zero :(';
      this.msg = 'Calculando. Fique atento, para haver naves precisamos de uma distância maior ou igual a 1000 mglt.';
      let hoursPerDay = 24;
      ...
      console.log(vm.spaceshipsWithstopNecessaries)
    }
  },
  methods: {
    //Private Method
